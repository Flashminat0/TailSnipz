...
import Ordermobiletableseller from "./ordermobiletableseller";
...
const orderStaticData = [{
    ...
    "order_desc": "black t shirt 2",
    "product": "Black T shirt 2",
    "order_price": "211",
    "amount": 222,
    "paymentStatus": "UnPaid",
    "orderStatus": "Cancelled by Customer",
...
const Ordermobiletablepage = () => {
    const [results, setResults] = useState(orderStaticData);
    const [selectedRows, setSelectedRows] = useState([]);

    return (
        <Mobiletablelayout>
            <Ordermobiletableseller data={results} setData={setResults} setSelectedRows={setSelectedRows}/>
        </Mobiletablelayout>
    );
};

export default Ordermobiletablepage;