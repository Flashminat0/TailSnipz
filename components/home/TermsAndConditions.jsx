  ...
  return (
    <div className='px-36'>
        <>
            ...
            <p className='text-gray-500 pt-2 text-lg leading-normal'>
                (iii) Professional Sellers. Professional Sellers are not authorized to use the Site. Do not use the Site for commercial purposes.
            </p>
            <p className='text-gray-500 pt-2 text-lg leading-normal'>
            ...
            <p className='text-gray-500 pt-1 text-lg leading-normal'>
                These Terms refer to and incorporate the following additional terms. By accepting these Terms, you also agree to these additional terms, which are incorporated by reference: Catalog Rules, Forum Rules, and Price List. Any violation of these additional terms is a breach of this Agreement. (In the event of any conflict between the provisions of such additional terms and the provisions of these Terms, the provisions in these Terms shall prevail.) 
            </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                Additionally, certain features of the Site use tools and services provided by third parties, which may be governed by separate terms and conditions. For example, if you use the Integrated payment service, you must agree to ADYEN N.V. terms and conditions (please see Clause 6.5.1 for more information on how users are requested to confirm ADYEN N.V.’s terms and conditions). When third-party tools and services are governed by separate terms and conditions, the Site will provide you with a link to the applicable terms and conditions. The latter will be made available to you in a format that allows them to be reproduced and stored within the relevant third-party services and must be separately accepted if you wish to use these third-party services.
            </p>
            ...
            <p className="font-semibold text-lg text-gray-500 pt-8 md:pl-12 pl-4">2. DEFINITIONS </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
            ...
            <p className="font-semibold text-lg text-gray-500 pt-8 md:pl-12 pl-4">3. LISTING ITEMS ON THE SITE </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                <b>3.1 Permitted Items.  </b>
                Only items that meet all of the following conditions may be listed on the Site: 
            </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                (i) The item must be in one of the categories listed in the Catalog Rules and the item must not be on ADYEN N.V.'s List of Prohibited Products and Services.
            </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
            ...
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                ...
                To list an item in the Catalog, the Seller must complete a questionnaire, which includes selecting a category that most accurately represents the Item being listed. The Seller must comply with all Catalog Rules relating to the listing of Items. 
            </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                <b>3.3 Offer for Sale.</b>
                When a Seller lists an Item in the Catalog and the listing is published on the Site, this constitutes an offer for sale of the relevant Item by the Seller, which may be accepted by a Buyer.
            </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                <b>3.4 Modifying a Listing. </b>
                The Seller who has listed an Item may withdraw the Item or amend the Listing (including the price) anytime before a Buyer clicks on the “Buy now” button for such Item.
            </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                <b>3.5 Additional Services. </b>
                The Seller may decide to purchase Additional Services, such as services designed to improve the visibility of their Items on the Site. Details about Additional Services (including pricing) are provided in the Price List. 
            </p>
            ...
            <p className="font-semibold text-lg text-gray-500 pt-8 md:pl-12 pl-4">5. BUYER PROTECTION SERVICE </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                <b>5.1 Buyer Protection. </b>
                Buyer Protection is added for a fee to every purchase made using the “Buy now” button. Buyer Protection enables a Buyer to seek a refund in certain circumstances, as further described in this Section 5.
            </p>
            ...
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                ...
                <div className='pl-8 pt-3'>
                    <ul className='list-disc'>
                        ...
                        <li>An amount equal to 5% of the Item price agreed between the Buyer and the Seller (not including shipping costs, any additional costs and applicable taxes).</li>
                    </ul>
                </div>
            </p>
            ...
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                <b>5.3.3 No Refund. </b>
                If there is something wrong with the Item received by the Buyer or the Item was not received by the Buyer but:
            </p>
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
            ...
            <p className='text-gray-500 pt-3 text-lg leading-normal'>
                ...
                All prices on the Site are expressed in United States Dollars (USD) and do not include applicable taxes. The final amount of applicable taxes will be shown to the User during Checkout.
            </p>
