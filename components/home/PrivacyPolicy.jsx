...
import PrivacyPolicyWrapper from "../layouts/PrivacyPolicyWrapper";
            ...
            <div className="py-12">
                <div className="bg-white max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 py-6">
                    <div className="lg:text-left">
                        ...
                        <div>
                            <p className="leading-loose my-5 text-3xl font-semibold">1. General</p>
                        </div>
                        ...
                        <div>
                            <p className="leading-normal font-medium mb-5 text-2xl">
                            ...
                            <div className="mx-auto w-full w-auto rounded-2xl bg-white p-2">
                                <Disclosure>
                                    {({open}) => (
                                        <>
                                            <Disclosure.Button
                                                className="flex w-full justify-between  px-4 py-2 text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-red-500 focus-visible:ring-opacity-75">
                        <span>
                                            ...
                                            <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                                <div className={'flex flex-col gap-3'}>
                                                    <p>
                                                        ...
                                                        procedure and access your Vinted account:
                                                    </p>
                                                    ...
                                                    <p>
                                                        ...
                                                        your Vinted account is deactivated or inactive for five (5)
                                                        years.
                                                    </p>
                                                </div>
                                            </Disclosure.Panel>
                                            ...
                                            <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                                <div className={'flex flex-col gap-3'}>
                                                    <p>
                                                        ...
                                                        Facebook or Apple account to your Vinted account, you will be
                                                    ...
                                                    <p>
                                                        ...
                                                        the following data with Vinted from your Google account (you may
