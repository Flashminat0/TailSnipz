...
const Header = () => {
  ...
  return (
      <div className={"px-1"}>
        <>
          <ul className="flex place-content-center gap-1">
            {/*logo */}
            <li className="mr-2">
            ...
            <li className="mr-2">
              <button
                  type="button"
                  className="inline-flex w-full justify-center mt-2 ml-4 font-sm rounded text-sm px-1  mb-2 "
              >
                <svg
                ...
                >
                  <Menu.Items className="origin-top absolute z-10 mt-8 w-96 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                      <Menu.Item>
                        ...
                        >
                          ...
                          <div className=" text-sm font-medium text-gray-700 bg-white">
                            <a href="components/mainheader/header#Header.jsx" className="block w-full px-1 py-2 ">
                              Clothes you don't wear = extra cash. Sell them
                              today. Upload now.
                            </a>
                            <a
                                href="components/mainheader/header#Header.jsx"
                      ...
                      <form method="POST" action="components/mainheader/header#Header.jsx">
                        <Menu.Item>
                          <button
                              type="submit"
            ...
            <li className="mr-2">
              <button
                  type="button"
                  className="inline-flex w-full justify-center mt-2  font-sm rounded text-sm px-1  mb-2 "
              >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6"
            ...
            <li className="mr-2">
              <button
                  type="button"
                  className="text-white bg-susty  mt-2  font-sm rounded text-sm px-1 py-1  mb-2 "
              >
                Sell now
              </button>
            </li>
          ...
          <div className="max-w-full mt-4">
            <div
                className="fixed pl-10 bg-white min-w-full border-t border-b border-gray-200"
            >
              <div offset={2}>
                <div className="flex min-w-max gap-6 text-sm cursor-pointer mt-0.5">
                  <Menu as="div">
                    <div
