    ...
    return (
        <>
            <div className={'flex flex-row justify-between items-center'}>
                <div className={'text-sm sm:text-lg font-medium pl-8'}>{items.length} items</div>
                {isSameUser === true ? <></> : <>
              ...
              />
                                    ...
                                    >
                                        <Listbox.Options
                                            className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-xs shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
