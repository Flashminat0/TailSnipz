                    ...
                    <div className={"p-3 grid grid-cols-3"}>
                        ...
                        <div className={"col-start-3 col-end-4"}>
                            <div className={"flex flex-row justify-end items-center gap-0.5 text-gray-400"}>
                                ...
                                {isFavourite === true ? <>
                            <span
                                className={"text-gray-500 font-medium text-sm"}>{singleProduct.favouriteCount + 1}</span>
                                </> : <>
                                    <span
                                        className={"text-gray-500 font-medium text-sm"}>{singleProduct.favouriteCount}</span>
                                </>}
                            </div>
                        </div>
                    </div>
