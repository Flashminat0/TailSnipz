...
import ProductCategoryFilterWrapper from "../layouts/ProductCategoryFilterWrapper";
import {useRouter} from "next/router";
import ClosetSpotlightItems from "../item/ClosetSpotlightItems";
import CommonItemCard from "../item/CommonItemCard";
import FilterItemSetWrapper from "../layouts/FilterItemSetWrapper";
...
const ProductItemsFilterSection = () => {
    ...
    useEffect(() => {
        ...
        if (sectionCount === 2) {
            ...
            setPagePathSet([{id: "a3138b2e-5447-4d29-b0e5-5bc4e08abad7", name: [mainsectionpage], href: "#"}, {id: "542118b3-5107-44e6-9ab8-a6fd4e121ba1", name: [sectionpage], href: "#"}])
        }
        if (sectionCount === 3) {
            ...
            setPagePathSet([{id: "282ab9ba-8680-4770-bbce-c189b835e97f", name: [mainsectionpage], href: "#"}, {id: "2d2e6c89-e944-4e61-bc6d-22e507cbc1ea", name: [sectionpage], href: "#"}, {
