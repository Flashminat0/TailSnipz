                    ...
                    loggedIn && (
                        <>
                            <div className='md:-ml-4 lg:-ml-4'>
                                <svg viewBox="0 0 24 24"  width="24" height="24" aria-label="Messages" fill='#9e9e9e' strokeWidth="0.5"><path d="M3.5 18.5V6.54l8.54 6.4 8.45-6.34v11.9H3.5zm15.95-13l-7.41 5.56L4.62 5.5h14.83zM20.5 4H3.5C2.67 4 2 4.67 2 5.5v13c0 .83.67 1.5 1.5 1.5h17c.82 0 1.5-.67 1.5-1.5v-13c0-.83-.68-1.5-1.5-1.5z"></path></svg>
                            </div>
                            <div>
                                <svg viewBox="0 0 24 24" width="24" height="24" aria-label="Notifications" fill='#9e9e9e' strokeWidth="0.5"><path d="M4.5 17.5c0-2.08 1.71-3.18 1.77-3.21l.73-.44V9a5.5 5.5 0 0 1 11 0v4l.01.84.7.44a4.01 4.01 0 0 1 1.79 3.22h-16zm8 3a2.5 2.5 0 0 1-2.29-1.5h4.58a2.5 2.5 0 0 1-2.29 1.5zm7-7.5V9a7 7 0 1 0-14 0v4S3 14.5 3 17.5c0 .83.67 1.5 1.5 1.5h4.14a4 4 0 0 0 7.72 0h4.14c.83 0 1.5-.67 1.5-1.5 0-3-2.5-4.5-2.5-4.5z"></path></svg>
                            </div>
                            <div className='md:mr-2 lg:mr-2 -mr-1'> 
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill='#9e9e9e' strokeWidth="0.5">
