  ...
  return (
      <div className={'mt-10 sm:mt-0'}>
        <div className="md:grid md:grid-cols-3 md:gap-6 bg-white px-6 py-2">
            <div className="px-3 md:col-span-1 flex items-center">
          ...
          <p className={'px-4 py-3 text-xs text-gray-500'}>We translate the most important information you need to buy, sell, and be in the know.</p>
