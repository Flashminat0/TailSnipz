  ...
  return (
    ...
    <div>
        <>
            ...
            <>
                <div className={"h-screen w-screen grid font-susty justify-start place-content-start pl-36 pt-20"}>
                    <>
                        <div className='w-96 bg-gray-50 p-6'>
                            <h1 className='font-bold justify-items-center text-2xl'>Invite friends and earn up to ${price} </h1>
                            ...
                            >
                                <li className="group grid grid-cols-12">
                                    <div className='col-span-11 flex'>
                                        <div>
                                            <img src="https://5a2583d7dd16c25cb2e8-358d15e499fca729302e63598be13736.ssl.cf3.rackcdn.com/referrals/referrals_icon.png" width="35px" height="35px"></img>
                                        </div>
                                        <div className='pl-5'>
                                        ...
                                        <div
                                            ...
                                            <motion.div
                                                ...
                                                <div className='grid place-content-center'>                                        
                                                    <img src="https://5a2583d7dd16c25cb2e8-358d15e499fca729302e63598be13736.ssl.cf3.rackcdn.com/referrals/rewards_invitee_empty_state.png" class="Image_content__lvAec" width="120px" height="120px" ></img>
                                                </div>
                                                <div className='grid place-content-center'>
                                                    <p className='text-2xl pt-6'>No friends have joined yet</p>
                                                </div>
                                                <div className='grid place-content-center'>
                                                    <p className='py-6'>Earn up to $15.00 to spend on Vinted — share your invite link with friends</p>
                                                </div>
