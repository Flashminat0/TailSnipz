...
const Verifycode = () => {
    ...
    return (
        <div className={"w-screen h-screen grid place-content-center font-susty"}>
            <>
                <div className={"flex flex-col max-w-max bg-gray-50 p-3"}>
                    ...
                    <div className={"p-4"}>
                        <input type={"text"} onChange={(e) => {
                            setInputVerifyCode(e.target.value)
                               ...
                               className={"px-4 py-1.5 text-sm rounded-md shadow-sm border border-gray-300 focus:border-susty focus:ring-susty focus:ring-offset-susty"}
                    ...
                    <div className={"flex flex-col text-xs font-medium"}>
                        ...
                        <div className={"mx-auto p-3"}>Having trouble? <Link href={"/"}><a
