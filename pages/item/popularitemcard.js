...
const Popularitemcard = ({index, src, alt, price, size, brand}) => {
    ...
    return (
        ...
        <>
            <div key={index} className={"hidden lg:block box-content w-56 min-h-max"}>
            ...
            <div key={index} className={"block lg:hidden box-content w-56 min-h-max"}>
                <div>
