                                    ...
                                    <motion.div
                                        ...
                                        <div
                                            ...
                                            <div className={"flex flex-col gap-2"}>
                                                <div className={"text-lg text-gray-500 font-medium mx-auto"}>Or log in with <span className={"text-susty hover:underline"}>Email</span></div>
                                                <div className={"text-lg text-gray-500 font-medium mx-auto"}>Don't have an account yet? <span className={"text-susty hover:underline"}>Sign up</span></div>
                                            </div>
                                        </div>
                                    </motion.div>
                                </div>
