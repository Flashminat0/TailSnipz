                                            ...
                                            <span
                                                ...
                                                <div className={"flex flex-col gap-2"}>
                                                    <div className={"text-lg text-gray-500 font-medium mx-auto"}>Or register
                                                        with <span onClick={()=>{setOpenSignupFormModal(true)}} className={"text-susty hover:underline"}>Email</span>
                                                    </div>
                                                ...
                                                onClick={() => setOpenSignupFormModal(false)}>
                                                      Close
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div className={"flex flex-col gap-2"}>
                                                                                    <div
                                                                                         className={"text-sm font-medium text-gray-500"}>By registering, I confirm that I accept Susty's <Link href={"/"}>
