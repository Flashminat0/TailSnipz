                                    ...
                                    {signupStatus === true ? <>
                                        ...
                                        <div
                                            ...
                                            <div className={"flex flex-col gap-2"}>
                                                <div className={"text-lg text-gray-500 font-medium mx-auto"}>Or register
                                                    with <span onClick={() => {
                                                        setOpenSignupFormModal(true)
                                                    }} className={"text-susty hover:underline"}>Email</span>
                                                </div>
                                        ...
                                        {openSignupFormModal === true ? <>
                                            ...
                                            <div
                                                ...
                                                <div className={"flex flex-col gap-2"}>
                                                    <div
                                                        className={"text-sm font-medium text-gray-500"}>By registering,
                                                        I
                                                        confirm that I accept Vinted's <Link href={"/"}>
                                                            <a className={"text-susty hover:underline"}>Terms and
                                                                Conditions,</a></Link> have read the <Link href={"/"}>
                                        ...
                                        {openLoginFormModal === true ? <>
                                            ...
                                            <div
                                                ...
                                                <div className={"flex flex-col gap-2 mt-3"}>
                                                    <div onClick={()=>{setOpenLoginFormModal(false)}} className={"text-lg font-medium mx-auto text-susty hover:underline"}>Forgotten
                                                        your password?
                                                    </div>
                                                    <div
                                                        className={"text-lg font-medium mx-auto text-susty hover:underline"}>Having
